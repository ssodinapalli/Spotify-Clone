...
function Bottombar() {
  return (
    ...
    <div className="bottomcontainer">
      <footer
        id="mh-footer"
        className="mh-footer-hover svelte-13h39ov snipcss-3ATHb"
      >
        <nav className="svelte-13h39ov">
          ...
          <div className="mh-top-links svelte-13h39ov">
            <dl className="svelte-12h6dnj">
          ...
          <div className="mh-social-icons svelte-13h39ov">
              ...
              <li className="svelte-1ad7r0v">
                ...
                >
                  <span
                    ...
                    className="mh-social-icon-instagram svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
              <li className="svelte-1ad7r0v">
                ...
                >
                  <span
                    role="img"
                    aria-label="Twitter"
                    className="mh-social-icon-twitter svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
              <li className="svelte-1ad7r0v">
                ...
                >
                  <span
                    role="img"
                    aria-label="Facebook"
                    className="mh-social-icon-facebook svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
            </ul>
          ...
          <div className="mh-bottom-links svelte-13h39ov">
            ...
            <span className="svelte-1so9ic8">© 2021 Spotify AB</span>
          </div>
        </nav>
      </footer>
      </div>
