...
import '../assests/ComponentCss/Bottombarr.css';
...
function Bottombar() {
  return (
    ...
    <div className="bottomcontainer">
      ...
      >
        <nav class="svelte-13h39ov">
          <div class="mh-brand svelte-13h39ov">
            <a
              href="https://www.spotify.com/us/"
              class="mh-footer-primary svelte-18o1xvt"
            >
          ...
          <div class="mh-top-links svelte-13h39ov">
            <dl class="svelte-12h6dnj">
              <dt class="svelte-12h6dnj">Company</dt>
              <dd class="svelte-12h6dnj">
                <a
                  href="https://www.spotify.com/us/about-us/contact/"
                  class="mh-footer-primary svelte-12h6dnj"
            ...
            <dl class="svelte-12h6dnj">
              <dt class="svelte-12h6dnj">Communities</dt>
              <dd class="svelte-12h6dnj">
                <a
            ...
            <dl class="svelte-12h6dnj">
              <dt class="svelte-12h6dnj">Useful links</dt>
              <dd class="svelte-12h6dnj">
                <a
          ...
          <div class="mh-social-icons svelte-13h39ov">
            <ul class="svelte-1ad7r0v">
              <li class="svelte-1ad7r0v">
                <a
                  href="https://instagram.com/spotify"
                  title="Instagram"
                  class="mh-footer-primary svelte-1ad7r0v"
                >
                  <span
                    role="img"
                    aria-label="Instagram"
                    class="mh-social-icon-instagram svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
              <li class="svelte-1ad7r0v">
                ...
                >
                  <span
                    role="img"
                    aria-label="Twitter"
                    class="mh-social-icon-twitter svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
              <li class="svelte-1ad7r0v">
                ...
                >
                  <span
                    role="img"
                    aria-label="Facebook"
                    class="mh-social-icon-facebook svelte-1ad7r0v"
                  ></span>
                </a>
              </li>
            </ul>
          </div>
          <div class="mh-country svelte-13h39ov">
            <a
              href="https://www.spotify.com/us/select-your-country-region/"
              class="mh-footer-secondary mh-compact svelte-1ouzkfx"
            >
              <svg
                width="12"
                height="13"
          ...
          <div class="mh-bottom-links svelte-13h39ov">
            ...
            <span class="svelte-1so9ic8">© 2021 Spotify AB</span>
          </div>
        </nav>
      </footer>
      </div>
